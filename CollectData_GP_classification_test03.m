...
close all; clear; 
rng(5) % used 3 before 10.3.2020
%% step1: collect different magnitude maneuvers
km = 1000;
length = 0; % track length
...
for maneu = maneuver
    file_path = ['D:\ops\GPclassification\maneuver_database\ImpulsiveManeuver\results-20200624-', num2str(maneu), 'mps.mat'];
    load(file_path);
...
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\training_input_data.mat', 'training_input_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\training_output_data.mat', 'training_output_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_1_input_data.mat', 'testing_1_input_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_1_output_data.mat', 'testing_1_output_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_2_input_data.mat', 'testing_2_input_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_2_output_data.mat', 'testing_2_output_data');

save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\nor_data_parameter.mat', 'Xmin', 'Xmax', 'Ymin', 'Ymax', 'Zmin', 'Zmax', 'kx', 'ky', 'kz', 'a', 'b');
% save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\AllData.mat');

%% Collect the data with unknown maneuver
unknown_maneuver = [1 5 9 10];
...
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_3_input_data.mat', 'testing_3_input_data');
save('D:\ops\GPclassification\CollectDatabase\multi_maneuver\train_with_3_5_10\testing_3_output_data.mat', 'testing_3_output_data');
