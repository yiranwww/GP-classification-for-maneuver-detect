...
% The training data and Test-1/Test-2 data are the position withourt noise
% Test-3 is with noise.
...
close all; clear; 
rng(12) % used 3 before 10.3.2020
%% step1: collect different magnitude maneuvers
km = 1000;
...
for maneu = maneuver
    file_path = ['D:\ops\GPclassification\maneuver_database\ImpulsiveManeuver_Robustness\results-20201019-', num2str(maneu), 'mps_5sigma.mat'];
    load(file_path);
...
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\training_input_data.mat', 'training_input_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\training_output_data.mat', 'training_output_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_1_input_data.mat', 'testing_1_input_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_1_output_data.mat', 'testing_1_output_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_2_input_data.mat', 'testing_2_input_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_2_output_data.mat', 'testing_2_output_data');

save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\nor_data_parameter.mat', 'Xmin', 'Xmax', 'Ymin', 'Ymax', 'Zmin', 'Zmax', 'kx', 'ky', 'kz', 'a', 'b');
% save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\AllData.mat');
...
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_3_input_data.mat', 'testing_3_input_data');
save('D:\ops\GPclassification\CollectDatabase\Impulsive_Robustness\train_3_5_10\5sigma\testing_3_output_data.mat', 'testing_3_output_data');
