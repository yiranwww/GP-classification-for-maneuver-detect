close all; clear;
% Load Data
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\training_input_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\training_output_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_1_input_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_1_output_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_2_input_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_2_output_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_3_input_data.mat');
load('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\testing_3_output_data.mat');
...
%   likfunc = @likGaussian;
  infunc = @infVB;
%   infunc = @infEP;
   hyp = minimize(hyp, @gp, -100, infunc, meanfunc, covfunc,...
...
% save('D:\ops\GPclassification\resultsaved\LowThrustManeuver\train468_test1359_onlyLowThrust\OnlyImpulsive_predictedResult.mat');
