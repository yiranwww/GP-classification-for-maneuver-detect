...
measure_gap = 1; % 
database_name = {'results-20201111-0.0050N-300s1500Isp_2sigma';
                               'results-20201111-0.0100N-300s1500Isp_2sigma';
                               'results-20201111-0.0200N-50s1500Isp_2sigma';
                               'results-20201111-0.0200N-100s1500Isp_2sigma';
                               'results-20201111-0.0200N-500s1500Isp_2sigma';
                               'results-20201111-0.2000N-300s1500Isp_2sigma';
                               'results-20201111-0.5000N-300s1500Isp_2sigma';
                               'results-20201111-1.0000N-300s1500Isp_2sigma';
                               'results-20201111-10.0000N-300s1500Isp_2sigma';
                               'results-20201111-50.0000N-300s1500Isp_2sigma'; %10
                               'results-20201019-1mps_2sigma';
                               'results-20201019-2mps_2sigma';
                               'results-20201019-3mps_2sigma';
                               'results-20201019-4mps_2sigma';
                               'results-20201019-5mps_2sigma';
                               'results-20201019-6mps_2sigma';
                               'results-20201019-7mps_2sigma';
                               'results-20201019-8mps_2sigma';
                               'results-20201019-9mps_2sigma';
                               'results-20201019-10mps_2sigma';};
...
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\training_input_data.mat', 'training_input_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\training_output_data.mat', 'training_output_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_1_input_data.mat', 'testing_1_input_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_1_output_data.mat', 'testing_1_output_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_2_input_data.mat', 'testing_2_input_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_2_output_data.mat', 'testing_2_output_data');

save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\nor_data_parameter.mat', 'Xmin', 'Xmax', 'Ymin', 'Ymax', 'Zmin', 'Zmax', 'kx', 'ky', 'kz', 'a', 'b');
...
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_3_input_data.mat', 'testing_3_input_data');
save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\testing_3_output_data.mat', 'testing_3_output_data');

save('D:\ops\GPclassification\CollectDatabase\All_Robustness\2sigma\AllData.mat');
